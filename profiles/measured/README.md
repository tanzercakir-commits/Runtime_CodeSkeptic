...
| file | host | source |
|---|---|---|
| `macos-14-arm64-native.measured.json` | macOS 14.8.7, Apple Silicon, native arm64 | `.github/workflows/macos-probe.yml`, job `native-arm64`, commit `2d9ea6c` |
| `macos-14-arm64-rosetta-x86_64.measured.json` | macOS 14.8.7, Apple Silicon, x86-64 under Rosetta 2 | same workflow, job `rosetta-x86_64`, commit `2d9ea6c` |
